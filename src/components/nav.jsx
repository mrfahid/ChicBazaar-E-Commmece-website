    ...
    >
      ...
      <div className="flex md:order-2">
        {currentUser ? (
          ...
          <button
            className="flex items-center space-x-2 bg-zinc-700 text-white mr-3 px-[12px] rounded hover:bg-zinc-600 transition-all"
        ...
        <NavLink
          ...
          to="/cart"
        >
          <img src={buketImage} alt="Cart" className="w-8 h-8 rounded-full bg-slate-400"/>
